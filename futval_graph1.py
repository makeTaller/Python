...
def main():
    ...
    window = GraphWin("Enter the Principal and APR",  320,240)
    window.setCoords(0.0,0.0,3.0,4.0)

    #Draw the first window 
    Text(Point(1,3)," Enter the Principal:").draw(window)
    Text(Point(1,3.5)," Enter the Apr:").draw(window)
